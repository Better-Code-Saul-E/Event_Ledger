    ...
    return (
        <div className="aboutus_container">
            ...
            <p> Event Ledger is specifically built for corporate event coordinators. 
                We provide solutions to streamline your entire financial process. Out team is 
                dedicated to porvinding exceptional support, guiding you every step of the way 
                to ensure every event is a financial success.
            </p>
        </div>
    )
}
